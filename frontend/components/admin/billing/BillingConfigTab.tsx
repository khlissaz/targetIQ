...
import { BillingPlanConfigForm } from './BillingPlanConfigForm';
...
export function BillingConfigTab() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {selectedCode ? (
        <BillingPlanConfigForm planCode={selectedCode} key={selectedCode} />
      ) : (
        <p className="text-sm text-gray-500">Select a plan to manage its configuration.</p>
      )}
    </div>
  );
}
